...
import static cn.xender.core.server.service.OAPConstant.MSG_GET_AP_INFO;
import static cn.xender.core.server.service.OAPConstant.MSG_OPEN_AP;


public class MyOAPService extends Service{
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            callback = new WifiManager.LocalOnlyHotspotCallback(){
                ...
                public void onStarted(WifiManager.LocalOnlyHotspotReservation reservation) {
                    ...
                    MyOAPService.this.reservation = reservation;
